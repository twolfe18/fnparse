...
public final class BasicFrameRoleFeatures extends AbstractFeatures<BasicFrameRoleFeatures> implements Features.FRE {
	...
	public FeatureVector getFeatures(Frame f, boolean argIsRealized, int targetHeadIdx, int roleIdx, Span argumentSpan, Sentence sent) {
		...
		b(fv, fsrs, "width=", String.valueOf(argumentSpan.width()));
		...
		b(fv, fsrs, "roleHead=", rHead.getFullString(), "targetHead=", tHead.getFullString());
		b(fv, fsrs, "roleHead=", rHead.getFullString(), "targetHead=", tHead.word);
		b(fv, fsrs, "roleHead=", rHead.getFullString(), "targetHead=", tHead.pos);
