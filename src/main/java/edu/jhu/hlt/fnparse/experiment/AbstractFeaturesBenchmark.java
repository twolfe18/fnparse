 ...
 * @author travis
 */
public class AbstractFeaturesBenchmark
    extends AbstractFeatures<AbstractFeaturesBenchmark> {
  ...
  public static void main(String[] args) {
    ...
    for (int i=0; i<10; i++) {
      ...
      System.out.printf(
          "[bench] new took %.2f seconds, old took %.2f\n", tn, to);
      if (i > 0) {
        ttn += tn;
        tto += to;
      }
    ...
    System.out.printf(
        "[bench] new took %.2f seconds total, old took %.2f total, %.1f %% gain\n",
