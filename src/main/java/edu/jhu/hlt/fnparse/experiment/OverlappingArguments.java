 ...
 * 
 * Can different roles (k) be filled by one headword/span (j) ? => YES (but rarely)
 * 
 * @author travis
 */
public class OverlappingArguments {
	...
	public static void main(String[] args) {
		...
		Iterator<FNTagging> iter = FileFrameInstanceProvider.fn15trainFIP.getParsedOrTaggedSentences();
		while(iter.hasNext()) {
		...
		System.out.printf("%d of %d (%.1f%%) FrameInstances have overlapping arguments\n",
