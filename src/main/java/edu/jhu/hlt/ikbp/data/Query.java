...
public class Query implements org.apache.thrift.TBase<Query, Query._Fields>, java.io.Serializable, Cloneable, Comparable<Query> {
  ...
  private Node subject; // required
  private PKB context; // required
  ...
  public Query(Query other) {
    ...
    if (other.isSetSubject()) {
      this.subject = new Node(other.subject);
    }
    if (other.isSetContext()) {
      this.context = new PKB(other.context);
    }
  }
  ...
  public Query setSubject(Node subject) {
    this.subject = subject;
    return this;
  }
  ...
  public Query setContext(PKB context) {
    this.context = context;
    return this;
  }
