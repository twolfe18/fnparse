...
public class RoleSequenceStageTest {
  ...
  public void test() {
    ...
    params.setFeatureTemplateDescription(
        "Role1 * Role2"
    ...
    RoleSequenceStage rss = new RoleSequenceStage(params, params);
    for (FNParse y : parses) {
      ...
      LOG.info("perf=" + perf);
      ModelIO.writeHumanReadable(rss.getWeights(), params.getAlphabet(),
