...
public class BasicLatentDepTest {
  ...
  @Test
  public void test() {
    FeatureNames featureAlphabet = new FeatureNames();
    ...
    LFgExample fge = new LabeledFgExample(fg, goldConfig);
